...
\textbf{Programming Languages}: Python, JavaScript, R, Java, C, C++, C\#, HTML, CSS, CoffeeScript, Ruby, Bash
...
\textbf{Data Mining}: Jupyter, NumPy, SciPy, Pandas, ggplot2, Plotly, NetworkX, MapReduce, NLTK, Mongo, SQL
...
\textbf{Web Development}: Node.js, Flask, Polymer, D3.js, React, Flow, Webpack, NoSQL (MongoDB, Redis), EC2
