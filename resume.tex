...
HabitLab: Personalized Interventions for Better Online Habits (to appear at CSCW 2018)\\
HabitLab is a Chrome extension and Android app which helps users achieve goals like reducing time on Facebook/Youtube, by deploying various interventions and determining which are most effective for users. \emph{8000+ daily active users,} \url{http://habitlab.stanford.edu/}
...
Effects of In-Video Quizzes on MOOC Lecture Viewing (published at L@S 2016)\\
...
QuizCram: Question-Driven Video Viewing (published at CHI 2015 SRC) %\hfill \textsl{Microsoft Research, 2014} \\
...
ScreenMatch: Visual Context for Software Translators (published at CHI 2012 SRC)\\ %\hfill \textsl{MIT CSAIL, UID group, 2012} \\  %\hfill \textsl{Fall 2011}\\
