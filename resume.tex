...
\textbf{Microsoft Research Asia} -- Research Intern, Beijing \hfill \textsl{Summer 2014}\\
...
\textbf{Google} -- Software Engineering Intern, Mountain View \hfill \textsl{2011, 2012, 2013 (3 Summer Internships)}\\
...
HabitLab is an online experimentation platform I developed during my PhD at Stanford with \emph{12,000+ daily active users}, which I have used to conduct a variety of experiments, data science, and machine learning work:
...
\textbf{Effects of In-Video Quizzes on MOOC Lecture Viewing (published at \textbf{Learning at Scale 2016})}\\
A large-scale data analysis of Coursera's in-video interaction logs across Machine Learning courses, analyzing effects of in-video quizzes on users' video watching and seeking behaviors (implemented in Python).
