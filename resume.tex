...
\textbf{Data Science}: Numpy, SciPy, Pandas, R, A/B testing, Mixed models, Survival analysis, Experiment Design
...
\textbf{Machine Learning}: PyTorch, TensorFlow, sklearn, Deep Learning (RNN, CNN), Multi-armed bandits, NLP % (RNN/CNN/GAN) %, NLP %, PCFG % Weka % sklearn % scikit-learn
