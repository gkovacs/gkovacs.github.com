...
\textbf{Programming Languages}: Python, JavaScript, C, C++, C\#, Java, CoffeeScript, LiveScript, Ruby, Bash, R
...
\textbf{Machine Learning}: PyTorch, TensorFlow, scikit-learn, Deep Learning (RNN, LSTM, CNN, GAN), NLP, RL %, PCFG % Weka % sklearn

%\textbf{Machine Learning} and \textbf{Data Science}: PyTorch, TensorFlow, Python, Numpy, SciPy, Pandas, Jupyter, R, rpy2

\vspace{-4mm}

\textbf{Web Backend}: Node.js (Express, Koa), Flask, MongoDB, PostgreSQL, Redis, Vagrant, Heroku, EC2, GCloud

\vspace{-4mm}

\textbf{Web Frontend}: HTML, CSS, JS, Polymer, D3, Plotly, CoffeeScript, Webpack, SystemJS, React, Flow, Sass
