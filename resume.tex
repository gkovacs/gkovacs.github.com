...
\textbf{FeedLearn: Microlearning in Facebook Feeds}\\ %\hfill \textsl{Stanford HCI group, ongoing} \\
...
\textbf{QuizCram: Question-Driven Video Viewing}\\ %\hfill \textsl{Microsoft Research, 2014} \\
...
\textbf{Smart Subtitles for Foreign Language Learning}\\ %\hfill \textsl{MIT CSAIL, UID group, 2013} \\ %\hfill \textsl{Spring 2012 -- Spring 2013} \\
Smart Subtitles lets you learn vocabulary while you watch foreign-language dramas.\\
...
\textbf{GrammarVis: Visualizing the Grammar of Foreign Languages}\\ %\hfill \textsl{MIT CSAIL, UID group, 2013} \\
...
\textbf{ScreenMatch: Visual Context for Software Translators}\\ %\hfill \textsl{MIT CSAIL, UID group, 2012} \\  %\hfill \textsl{Fall 2011}\\
