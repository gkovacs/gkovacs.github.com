...
Designed and built an educational social feed experience for teaching literacy and mathematics skills.
...
Smart Subtitles is a video viewer that uses an interactive transcript to help learners learn vocabulary while viewing foreign-language videos. User learned more vocabulary when using it, compared to bilingual subtitles.
