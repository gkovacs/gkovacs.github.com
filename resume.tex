...
\textit{QuizCram: Question-Driven Video Viewing (CHI 2015 SRC)}\\ %\hfill \textsl{Microsoft Research, 2014} \\
...
\textit{Smart Subtitles for Foreign Language Learning (CHI 2014 full paper)}\\ %\hfill \textsl{MIT CSAIL, UID group, 2013} \\ %\hfill \textsl{Spring 2012 -- Spring 2013} \\
...
\textit{GrammarVis: Visualizing the Grammar of Foreign Languages (UIST 2013 demo)}\\ %\hfill \textsl{MIT CSAIL, UID group, 2013} \\
...
\textit{ScreenMatch: Visual Context for Software Translators (CHI 2012 SRC)}\\ %\hfill \textsl{MIT CSAIL, UID group, 2012} \\  %\hfill \textsl{Fall 2011}\\
...
Kiley Sobel, \textbf{Geza Kovacs}, Galen McQuillen, Andrew Cross, Nirupama Chandrasekaran, Nathalie Riche, Ed Cutrell, Meredith Morris. ``EduFeed: A Social Feed to Engage Preliterate Children in Educational Activities". ACM annual conference on Computer Supported Collaborative Work (CSCW) 2017, Full Paper (to appear).

\textbf{Geza Kovacs}. ``Effects of In-Video Quizzes on MOOC Lecture Viewing.'' ACM annual conference on Learning at Scale (L@S) 2016, Full Paper.
...
Finalist and Honorable Mention, MIT 6.470 Web Programming Competition, 2013\\ % (Project: PsetParty)
