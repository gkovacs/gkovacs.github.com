...
HabitLab (\url{https://habitlab.stanford.edu}) is an online experimentation platform with \emph{12,000+ daily active users} that I built. I have used it to conduct a variety of data science experiments and machine learning work:
...
%Smart Subtitles for Foreign Language Learning (published at CHI 2014) %\hfill \textsl{MIT CSAIL, UID group, 2013} \\ %\hfill \textsl{Spring 2012 -- Spring 2013} \\
%\begin{compactitem}
%\item Smart Subtitles is a video viewer that uses an interactive transcript to help learners learn vocabulary while viewing foreign-language videos.  A system that A large-scale data analysis of Coursera's in-video interaction logs across Machine Learning courses, analyzing effects of in-video quizzes on users' video watching and seeking behaviors (Python/Pandas)
%\end{compactitem}
...
\textbf{Full-Stack Engineering}: Node.js, Flask, MongoDB, Redis, PostgreSQL, Flow, TypeScript, Webpack, EC2 %, GCloud %, EC2
...
\section{\mysidestyle Press\\Coverage}

\textbf{HabitLab}\\
Wired: HabitLab Browser Extension Curbs Your Time Wasted on the Web (Jan 28, 2019)\\
The New York Times: Finding it Hard to Focus? Maybe It's Not Your Fault (Aug 14, 2018)\\
Lifehacker: Be More Mindful of the Time You Waste Online With HabitLab (Aug 5, 2018)

\textbf{Daemo / Crowd Research}\\
Wired: Amazon Mechanical Turk Workers Have Had Enough (Aug 23, 2017)

\textbf{UNetbootin}\\
Forbes: How To Try Linux Without Making Any Changes To Your PC (Sep 18, 2018)\\
Lifehacker: How to Get Started With the Ubuntu Linux Distro (Nov 17, 2017)

\textbf{Wubi}\\
Ars Technica: Wubi arrives: a look at Ubuntu 8.04 alpha 5 (Feb 24, 2008)\\
Lifehacker: Install Ubuntu on a Windows Netbook, No Partitioning Needed (May 19, 2010)
