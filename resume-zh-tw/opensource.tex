...
\textbf{UNetbootin}（Live USB 製作工具） \hfill \url{https://en.wikipedia.org/wiki/UNetbootin}\\ %\hfill \textsl{2007 年 1 月 -- 至今}\\
...
\textbf{Wubi}（Windows 版 Ubuntu 安裝程式） \hfill \url{https://en.wikipedia.org/wiki/Wubi_(software)}\\ %\hfill \textsl{2006 年 11 月 -- 2007 年 8 月}\\
