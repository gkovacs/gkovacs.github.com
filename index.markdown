I'm Geza Kovacs, a 2<sup>nd</sup> year Computer Science PhD student at Stanford supported by the NDSEG fellowship.
...
<a href="https://venmo.com/?txn=pay&amp;recipients=gkovacs&amp;amount=5.00&amp;note=for%20UNetbootin%20Development&amp;audience=public" target="_blank"><div style="font-size: 12px; color: #444; border: 1px solid #ccc; border-radius: 5px; display: inline-block; left: auto; right: auto; padding: 3px; margin-right: 5px; font-weight: bold; width: 150px; text-align: center"><img src="venmo.png" style="float: left; padding-right: 5px" alt="Donate via Venmo" /> Donate via Venmo</div></a>
