...
<div class="padlink"></div>
<div class="paratext">
A phonetic input method for Cantonese that allows you to unambiguously type a syllable with 2 keystrokes, or 3 if including tones. Designed to be easy to learn by users of Double Pinyin (雙拼) for Mandarin. Based on the RIME IME.<br class="desktoponly">
</div>
<div class="padlink2"></div>
<div class="boxlc">
<a class="boxlink" href="https://github.com/gkovacs/fcitx-rime-config/blob/master/README.md">GitHub</a>
