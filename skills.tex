...
\textbf{Programming Languages}: Python, JavaScript, C, C++, Java, TypeScript, R, C\#, Ruby, Haskell, HTML, CSS, SQL %, Scala, C\#, Ruby, CoffeeScript, Haskell, Bash
